<x-guest-layout >
    <div x-data="{show:false}" class="flex flex-col bg-indigo-900 w-full w-full h-screen">
       <nav class="flex pt-5 justify-around items-center container  mx-auto text-indigo-200">
        ...
        <div class="flex container-xl mx-auto items-center h-full ">
            <div class="flex flex-col mx-5  items-start" >
                ...
                <x-button x-on:click="show=true" class="py-3 px-8 bg-red-500 hover:bg-red-600">Join us 😅</x-button>
            </div>
        </div>
...
<div x-show="show" x-on:click.self="show=false"
